    ...
    <div className="space-y-5 max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#1a4a8a] text-white text-sm font-semibold hover:bg-[#163d73] transition-colors disabled:opacity-60"
        >
            ...
            {casos.map((c) => (
              <div key={c.id} className="flex items-center gap-3 px-4 py-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md border border-[#1a4a8a] text-[#1a4a8a] text-xs font-semibold hover:bg-[#1a4a8a] hover:text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed shrink-0"
                >
